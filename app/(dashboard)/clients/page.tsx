  ...
  return (
    <div>
      ...
      {!clients || clients.length === 0 ? (
        ...
        <div className="overflow-x-auto rounded-xl border border-[#0033AA]/8 bg-white shadow-sm">
                    ...
                    <td className="px-5 py-3.5">
                      <Link href={`/clients/${client.id}`} className="flex items-center gap-3">
                        ...
                        <span className="leading-tight">
                          <span className="block font-medium text-[#0A2240] hover:text-[#0033AA]">{client.full_name}</span>
                    ...
                    <td className="px-5 py-3.5">
                      {account && ProductIcon ? (
                        <span className="inline-flex items-center gap-1.5 text-[#0A2240]/70">
                          <ProductIcon size={14} className={account.product_type === "fixed_deposit" ? "text-[#0A2240]/45" : "text-[#0033AA]/55"} />
